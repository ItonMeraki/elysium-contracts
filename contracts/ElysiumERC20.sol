...
/**
   ...
   0.5% fee auto distributes to all holders
 */
...
contract ElysiumERC20 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Elysium";
    string private _symbol = "ELYS";
    ...
    function transferExactAmountCountingFees(
        uint256 tAmount
    ) public view returns (uint256) {
        require(tAmount <= _tTotal, "Amount must be less than supply");
        (, uint256 rTransferAmount, , , , ) = _getValues(tAmount);
        return tAmount + (tAmount - rTransferAmount);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        //transfer amount, it will take tax, dev fee
